        ...
        with sess.as_default():
            ...
            with tf.control_dependencies(tf.get_collection(tf.GraphKeys.UPDATE_OPS)):
                learning_rate = tf.train.exponential_decay(learning_rate=args.learning_rate,
                                                           global_step=hmidp.global_step, decay_steps=args.decay_steps,
                ...
                train_op = optimizer.apply_gradients(zip(grads, vars), global_step=hmidp.global_step, name="train_op")
            ...
            def train_step(x_batch_content, x_batch_question, x_batch_option, y_batch):
                ...
                feed_dict = {
                    ...
                    hmidp.dropout_keep_prob: args.dropout_rate,
                    hmidp.is_training: True
                }
                _, step, summaries, loss = sess.run(
                    [train_op, hmidp.global_step, train_summary_op, hmidp.loss], feed_dict)
            ...
            def validation_step(x_val_content, x_val_question, x_val_option, y_val, writer=None):
                ...
                for batch_validation in batches_validation:
                    ...
                    step, summaries, scores, cur_loss = sess.run(
                        [hmidp.global_step, validation_summary_op, hmidp.scores, hmidp.loss], feed_dict)
