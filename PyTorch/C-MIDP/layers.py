...
class CMIDP(nn.Module):
    ...
    def _setup_fc_layer(self):
        """
         Creating FC Layer.
         """
        self.fc = nn.Linear(in_features=self.args.num_filters[1], out_features=self.args.fc_dim, bias=True)
    ...
    def _sub_network(self, x_content, x_question, x_option):
        ...
        fc_out = self.fc(conv_final_flat)
